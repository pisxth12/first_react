...
const Main = () => {
  ...
  <div className="main-content">
    <aside className='border border-1'>
      <img className='w-100 h-100 object-fit-cover' src="https://i.ytimg.com/vi/Pzrdr6oLfdA/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLALg6yGmtUcwbyRkjGzCsdGKRcOIA" alt="" />
    </aside>
